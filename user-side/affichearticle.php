...
<body>
    ...
    if ($res) {
        echo "<table>";
        echo "<tr><th>ID Article</th><th>Nom</th><th>Description</th><th>Prix</th><th class='image-column'>Image</th><th>Actions</th></tr>";
        ...
        while ($l = $res->fetch(PDO::FETCH_ASSOC)) {
            ...
            <form action='modife.php' method='get' style='display:inline;'>
                <input type='hidden' name='idArticle' value='" . htmlspecialchars($l['idArticle']) . "'>
                <button type='submit' class='modify-btn' title='Modify'>Modify</button>
            </form>

            <form action='supp.php?id=" . htmlspecialchars($l['idArticle']) . "' method='post' style='display:inline;' onsubmit='return confirmDelete();'>
